...
public class RegisterTest {
	...
	private String path = "http://localhost:8080/Opdracht1A_war_exploded/Controller";
	...
	public void setUp() {
		...
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\elias\\Documents\\Toegepaste Informatica\\2de jaar\\1ste semester\\Webontwikkeling 3\\Selenium\\chromedriver2.exe");
		driver = new ChromeDriver();
		driver.get(path+"?action=Add");
	}
